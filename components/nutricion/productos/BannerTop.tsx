    ...
    return (
        <div className="w-full flex px-10">
            <div className="w-2/3">
                ...
                <NavigationSanam openNew={true} route='https://naoxcolombia.com/' styleDiv='absolute bg-teal-300 p-4 rounded-xl border border-slate-400 hover:border-slate-200 shadow-xl top-1/5 left-1/2 -transform-translate-x-1/5 -translate-y-1/2' styleSpan='text-2xl text-slate-800' title='Tienda Naox' />
